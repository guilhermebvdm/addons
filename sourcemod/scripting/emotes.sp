...
{
	AddFileToDownloadsTable("models/player/custom_player/kodua/emotes.mdl");
	AddFileToDownloadsTable("models/player/custom_player/kodua/emotes.vvd");
	AddFileToDownloadsTable("models/player/custom_player/kodua/emotes.dx90.vtx");

	// Edit
	// Add the sound file routes here
	AddFileToDownloadsTable("sound/kodua/emotes/ninja_dance_01.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/dance_soldier_03.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/hip_hop_good_vibes_mix_01_loop.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_zippy_a.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_electroshuffle_music.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_aerobics_01.wav"); 
	AddFileToDownloadsTable("sound/kodua/emotes/athena_music_emotes_bendy.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_bandofthefort_music.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_boogiedown.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_capoeira.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_flapper_music.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_chicken_foley_01.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_cry.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_music_boneless.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emotes_music_shoot_v7.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/Athena_Emotes_Music_SwipeIt.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_disco.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_worm_music.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_music_emotes_takethel.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_breakdance_music.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/Emote_Dance_Pump.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_ridethepony_music_01.mp3"); 
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_facepalm_foley_01.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/Athena_Emotes_OnTheHook_02.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_floss_music.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/Emote_FlippnSexy.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_fresh_music.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_groove_jam_a.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/br_emote_shred_guitar_mix_03_loop.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/Emote_HeelClick.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/s5_hiphop_breakin_132bmp_loop.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/Emote_Hotstuff.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_hula_01.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_infinidab.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_Intensity.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_irish_jig_foley_music_loop.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/Athena_Music_Emotes_KoreanEagle.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_kpop_01.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_laugh_01.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_LivingLarge_A.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/Emote_Luchador.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/Emote_Hillbilly_Shuffle.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_samba_new_B.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_makeitrain_music.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/Athena_Emote_PopLock.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/Emote_PopRock_01.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_robot_music.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_salute_foley_01.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/Emote_Snap1.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/emote_stagebow.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/Emote_Dino_Complete.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_founders_music.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emotes_music_twist.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/Emote_Warehouse.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/Wiggle_Music_Loop.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/Emote_Yeet.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/youre_awesome_emote_music.mp3");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emotes_lankylegs_loop_02.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/eastern_bloc_musc_setup_d.wav");
	AddFileToDownloadsTable("sound/kodua/emotes/athena_emote_hot_music.wav");

	// This dont touch
	PrecacheModel("models/player/custom_player/kodua/emotes.mdl", true);

	// Edit
	// Add mp3 files without sound/
	// Add wav files with */
	PrecacheSound("kodua/emotes/ninja_dance_01.mp3");
	PrecacheSound("kodua/emotes/dance_soldier_03.mp3");
	PrecacheSound("*/kodua/emotes/hip_hop_good_vibes_mix_01_loop.wav");
	PrecacheSound("*/kodua/emotes/emote_zippy_a.wav");
	PrecacheSound("*/kodua/emotes/athena_emote_electroshuffle_music.wav");
	PrecacheSound("*/kodua/emotes/emote_aerobics_01.wav");
	PrecacheSound("*/kodua/emotes/athena_music_emotes_bendy.wav");
	PrecacheSound("*/kodua/emotes/athena_emote_bandofthefort_music.wav");
	PrecacheSound("*/kodua/emotes/emote_boogiedown.wav");
	PrecacheSound("kodua/emotes/emote_capoeira.mp3");
	PrecacheSound("*/kodua/emotes/athena_emote_flapper_music.wav");
	PrecacheSound("*/kodua/emotes/athena_emote_chicken_foley_01.wav");
	PrecacheSound("kodua/emotes/emote_cry.mp3");
	PrecacheSound("*/kodua/emotes/athena_emote_music_boneless.wav");
	PrecacheSound("*/kodua/emotes/athena_emotes_music_shoot_v7.wav");
	PrecacheSound("*/kodua/emotes/Athena_Emotes_Music_SwipeIt.wav");
	PrecacheSound("*/kodua/emotes/athena_emote_disco.wav");
	PrecacheSound("kodua/emotes/athena_emote_worm_music.mp3");
	PrecacheSound("*/kodua/emotes/athena_music_emotes_takethel.wav");
	PrecacheSound("kodua/emotes/athena_emote_breakdance_music.mp3");
	PrecacheSound("*/kodua/emotes/Emote_Dance_Pump.wav");
	PrecacheSound("kodua/emotes/athena_emote_ridethepony_music_01.mp3");
	PrecacheSound("kodua/emotes/athena_emote_facepalm_foley_01.mp3");
	PrecacheSound("kodua/emotes/Athena_Emotes_OnTheHook_02.mp3");
	PrecacheSound("*/kodua/emotes/athena_emote_floss_music.wav");
	PrecacheSound("kodua/emotes/Emote_FlippnSexy.mp3");
	PrecacheSound("*/kodua/emotes/athena_emote_fresh_music.wav");
	PrecacheSound("*/kodua/emotes/emote_groove_jam_a.wav");
	PrecacheSound("*/kodua/emotes/br_emote_shred_guitar_mix_03_loop.wav");
	PrecacheSound("kodua/emotes/Emote_HeelClick.mp3");
	PrecacheSound("*/kodua/emotes/s5_hiphop_breakin_132bmp_loop.wav");
	PrecacheSound("kodua/emotes/Emote_Hotstuff.mp3");
	PrecacheSound("*/kodua/emotes/emote_hula_01.wav");
	PrecacheSound("*/kodua/emotes/athena_emote_infinidab.wav");
	PrecacheSound("*/kodua/emotes/emote_Intensity.wav");
	PrecacheSound("*/kodua/emotes/emote_irish_jig_foley_music_loop.wav");
	PrecacheSound("*/kodua/emotes/Athena_Music_Emotes_KoreanEagle.wav");
	PrecacheSound("*/kodua/emotes/emote_kpop_01.wav");
	PrecacheSound("kodua/emotes/emote_laugh_01.mp3");
	PrecacheSound("*/kodua/emotes/emote_LivingLarge_A.wav");
	PrecacheSound("kodua/emotes/Emote_Luchador.mp3");
	PrecacheSound("*/kodua/emotes/Emote_Hillbilly_Shuffle.wav");
	PrecacheSound("*/kodua/emotes/emote_samba_new_B.wav");
	PrecacheSound("kodua/emotes/athena_emote_makeitrain_music.mp3");
	PrecacheSound("*/kodua/emotes/Athena_Emote_PopLock.wav");
	PrecacheSound("*/kodua/emotes/Emote_PopRock_01.wav");
	PrecacheSound("*/kodua/emotes/athena_emote_robot_music.wav");
	PrecacheSound("kodua/emotes/athena_emote_salute_foley_01.mp3");
	PrecacheSound("kodua/emotes/Emote_Snap1.mp3");
	PrecacheSound("kodua/emotes/emote_stagebow.mp3");
	PrecacheSound("kodua/emotes/Emote_Dino_Complete.mp3");
	PrecacheSound("*/kodua/emotes/athena_emote_founders_music.wav");
	PrecacheSound("*/kodua/emotes/athena_emotes_music_twist.wav");
	PrecacheSound("*/kodua/emotes/Emote_Warehouse.wav");
	PrecacheSound("*/kodua/emotes/Wiggle_Music_Loop.wav");
	PrecacheSound("kodua/emotes/Emote_Yeet.mp3");
	PrecacheSound("kodua/emotes/youre_awesome_emote_music.mp3");
	PrecacheSound("*/kodua/emotes/athena_emotes_lankylegs_loop_02.wav");
	PrecacheSound("*/kodua/emotes/eastern_bloc_musc_setup_d.wav");
	PrecacheSound("*/kodua/emotes/athena_emote_hot_music.wav");
}
...
Action CreateEmote(int client, const char[] anim1, const char[] anim2, const char[] soundName, bool isLooped)
{
	...
	if (IsValidEntity(EmoteEnt))
	{
		...
		DispatchKeyValue(EmoteEnt, "model", "models/player/custom_player/kodua/emotes.mdl");
		...
		if (g_cvEmotesSounds.BoolValue && !StrEqual(soundName, ""))
		{
			...
			if (IsValidEntity(EmoteSoundEnt))
			{
				...
				if (isLooped)
				{
					FormatEx(g_sEmoteSound[client], PLATFORM_MAX_PATH, "*/kodua/emotes/%s.wav", soundNameBuffer);
				} else
				{
					FormatEx(g_sEmoteSound[client], PLATFORM_MAX_PATH, "kodua/emotes/%s.mp3", soundNameBuffer);
				}
