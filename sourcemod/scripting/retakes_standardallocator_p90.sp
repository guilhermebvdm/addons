...
public void GiveWeaponMenuCT(int client) {
    ...
    AddMenuInt(menu, rifle_choice_ct_m4a1_s, "Biquinho");
    AddMenuInt(menu, rifle_choice_ct_aug, "Aug");
    AddMenuInt(menu, rifle_choice_ct_p90, "P90jenta");
    DisplayMenu(menu, client, MENU_TIME_LENGTH);
}
...
public void GiveWeaponMenuT(int client) {
    ...
    AddMenuInt(menu, rifle_choice_t_sg553, "Kriger");
    AddMenuInt(menu, rifle_choice_t_p90, "P90jenta");
    DisplayMenu(menu, client, MENU_TIME_LENGTH);
}
